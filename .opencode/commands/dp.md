...
Создай commit только с текущими изменениями, не добавляй секреты, временные файлы и пустые коммиты. Определи текущую ветку и remote, затем выполни push без force. Если remote отсутствует или push не удался, остановись и сообщи причину.
